...
{
    /// <summary>
    /// This class creates the Vulture enemy for the game. Inherits from DrawableGameComponent
    /// </summary>
    public class Vulture : DrawableGameComponent
    {
        ...
        {
            return new Rectangle((int)position.X, (int)position.Y, tex.Width / 2, tex.Height);
        }
        /// <summary>
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (goVulture == 0)
            {
                if (currentTime > 23)
                {
                    position = new Vector2(-5, Shared.stage.Y - 400);
            ...
            if (goVulture == 1)
            {
                if (currentTime > 44)
                {
                    position = new Vector2(-5, Shared.stage.Y - 250);
                    position += new Vector2(4, 0);
                    goVulture++;
                }
            ...
            if (goVulture == 3)
            {
                if (currentTime > 107)
                {
                    position = new Vector2(-5, Shared.stage.Y - 450);
                    position += new Vector2(4, 0);
                    goVulture++;
                }

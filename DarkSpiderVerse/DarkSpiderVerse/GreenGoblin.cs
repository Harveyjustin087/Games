...
{
    /// <summary>
    /// This class creates the Green Goblin enemy for the game. Inherits from DrawableGameComponent
    /// </summary>
    public class GreenGoblin : DrawableGameComponent
    {
        ...
        {
            return new Rectangle((int)position.X, (int)position.Y, tex.Width/4, tex.Height);
        }
        /// <summary>
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (goGobby == 1)
            {
                if (currentTime > 32)
                {
                    position = new Vector2(-5, Shared.stage.Y - 200);
                    position += new Vector2(4, 0);
                    goGobby++;
                    voice.Play();
                }
